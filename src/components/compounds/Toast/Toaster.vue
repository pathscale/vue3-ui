...
import { reactive, computed, onMounted, onBeforeMount, onBeforeUnmount, ref } from 'vue'
...
export default {
  ...
  setup(props) {
    ...
    function shouldQueue() {
      ...
      return state.parentTop.childElementCount > 0 || state.parentBottom.childElementCount > 0
    }
    ...
    function showNotice() {
      ...
      state.timer = props.duration !== false ? new Timer(close, props.duration) : null
    }
