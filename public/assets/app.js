...
(function () {
    ...
    var script = defineComponent({
      ...
      props: {
        ...
        rounded: {
          type: Boolean,
          default() {
            return config2.defaultButtonRounded;
          }
        },
        loading: Boolean,
        outlined: Boolean,
        ...
        tag: {
          ...
          default: "button",
          validator(value) {
            return config2.defaultLinkTags.includes(value);
          }
        }
      },
      setup(props, {attrs}) {
        const computedTag = computed$1(() => {
          return "button";
        });
        return {
          computedTag
    ...
    function render(_ctx, _cache) {
      return (openBlock(), createBlock("button", mergeProps({
        ...
        (_ctx.label)
          ? (openBlock(), createBlock("span", _hoisted_1, _toDisplayString(_ctx.label), 1 /* TEXT */))
    ...
    script.__file = "src/components/primitives/Button/Button.vue";
    ...
    const _hoisted_1$1 = {
      class: ["py-4 px-4", `bg-grey-700 max-w-sm rounded overflow-hidden shadow-lg bg-opacity-90`]
    };
    ...
    script$1.__file = "src/components/primitives/Card/Card.vue";
    ...
    const _withId = /*#__PURE__*/withScopeId("data-v-156262bc");

    const render$2 = /*#__PURE__*/_withId(function render(_ctx, _cache) {
      return (openBlock(), createBlock(resolveDynamicComponent(_ctx.variant), {
        class: `font-sans font-normal text-white ${_ctx.variant}`
      }, {
        default: _withId(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
    ...
    script$2.__scopeId = "data-v-156262bc";
    script$2.__file = "src/components/primitives/Typography/Typography.vue";

    var script$3 = defineComponent({
      name: "App",
      components: {
        CardComponent: script$1,
        ButtonComponent: script,
        TypographyComponent: script$2
      }
    });

    const _hoisted_1$2 = /*#__PURE__*/createTextVNode("Buttons");
    const _hoisted_2 = /*#__PURE__*/createTextVNode("Button");
    const _hoisted_3 = /*#__PURE__*/createTextVNode("Rounded button");
    const _hoisted_4 = /*#__PURE__*/createTextVNode("Loading button");
    const _hoisted_5 = /*#__PURE__*/createTextVNode("Outlined button");
    const _hoisted_6 = /*#__PURE__*/createTextVNode("Hovered button");
    const _hoisted_7 = /*#__PURE__*/createTextVNode("Selected button");
    const _hoisted_8 = /*#__PURE__*/createTextVNode("Expanded button");

    function render$3(_ctx, _cache) {
      const _component_TypographyComponent = resolveComponent("TypographyComponent");
      ...
      return (openBlock(), createBlock(_component_CardComponent, null, {
        default: withCtx(() => [
          createVNode(_component_TypographyComponent, { variant: "h1" }, {
            default: withCtx(() => [
              _hoisted_1$2
            ]),
            _: 1
          }),
          createVNode(_component_ButtonComponent, null, {
            default: withCtx(() => [
              _hoisted_2
            ]),
            _: 1
