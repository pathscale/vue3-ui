...
describe("Pagination", () => {
  ...
  it("disables previous button on first page", () => {
    ...
    expect(
      wrapper.find(".pagination-previous").attributes("disabled"),
    ).toBeDefined();
  });
  ...
  it("disables next button on last page", () => {
    ...
    expect(
      wrapper.find(".pagination-next").attributes("disabled"),
    ).toBeDefined();
  });
  ...
  it("handles aria labels correctly", () => {
    ...
    expect(wrapper.find(".pagination-next").attributes("aria-label")).toBe(
      "Next page",
    );
    expect(wrapper.find(".pagination-previous").attributes("aria-label")).toBe(
      "Previous page",
    );
